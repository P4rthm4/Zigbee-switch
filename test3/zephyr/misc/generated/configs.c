...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_ZBOSS_NVRAM, 0x4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_APP_UTILS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_APP_UTILS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_PANID_CONFLICT_RESOLUTION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_FACTORY_RESET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FACTORY_RESET_PRESS_TIME_SECONDS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_ZIGBEE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_CHANNEL_SELECTION_MODE_SINGLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_CHANNEL, 11);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_ROLE_END_DEVICE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBOSS_RESET_ON_ASSERT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBOSS_OSIF_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBOSS_OSIF_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_HAVE_SERIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_NVRAM_PAGE_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_TC_REJOIN_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_TIME_COUNTER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_POWER_DOWN_LIBRARY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_POWERDOWN_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAM_POWERDOWN_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZIGBEE_LIBRARY_PRODUCTION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_CUSTOM_IEEE802154, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_CUSTOM_IEEE802154_MTU, 127);
